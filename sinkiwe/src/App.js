        ...
        <Router>
          <ScrollToTop>
            <Routes>
              ...
              />
              <Route
                path="admin/view-portraiture"
                element={
                  <RequireAuth>
                    <ViewUploadedPortraiture />
                  </RequireAuth>
                }
              />
              <Route
                path="admin/nature-upload"
                element={
                  <RequireAuth>
                    <UploadNature />
                  </RequireAuth>
              ...
              />
              <Route
                path="admin/view-weddings"
                element={
                  <RequireAuth>
                    <ViewUploadedWeddings />
                  </RequireAuth>
                }
              />
              <Route
                path="admin/fineart-upload"
                element={
                  <RequireAuth>
                    <UploadFineArt />
                  </RequireAuth>
