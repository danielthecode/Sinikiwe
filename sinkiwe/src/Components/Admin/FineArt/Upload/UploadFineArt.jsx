...
function UploadWedding() {
  ...
  function UploadImage () {
    ...
    let uploadPromises = images.map(image => {
      ...
      const imageRef = ref(storage, `FineArt/${newImage.name + v4()}`)
      ...
      () => {
        getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
           ImageService.addImage(collection(db, "fineArt"),downloadURL)
  ...
  return (
    <div className="upload-container">
      <div className="title">Upload Fine Art Image</div>
