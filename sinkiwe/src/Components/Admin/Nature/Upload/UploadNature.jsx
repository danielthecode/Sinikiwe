...
function UploadNature() {
  ...
  function UploadImage () {
    ...
    let uploadPromises = images.map(image => {
      ...
      const imageRef = ref(storage, `Nature/${newImage.name + v4()}`)
      ...
      () => {
        getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
           ImageService.addImage(collection(db, "nature"),downloadURL)
  ...
  return (
    <div className="upload-container">
      <div className="title">Upload Nature Image</div>
